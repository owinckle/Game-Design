...
class Obstacle(pg.sprite.Sprite):
	def __init__(self, game, x, y, type):
		...
		self.game	= game
		self.image	= pg.image.load(game.tiles.obstacles[0]).convert_alpha()
...
class Teleporter(pg.sprite.Sprite):
	def __init__(self, game, x, y):
		...
		pg.sprite.Sprite.__init__(self, self.groups)
		self.game	= game
		self.image	= pg.image.load(game.tiles.ground[0]).convert_alpha()
		self.rect	= self.image.get_rect()
		self.pos	= vec(x, y)
		self.rect.x	= x * game.config.tilesize
		self.rect.y	= y * game.config.tilesize
...
class Npc(pg.sprite.Sprite):
	def __init__(self, game, x, y):
		...
		pg.sprite.Sprite.__init__(self, self.groups)
		self.game	= game
		self.image	= pg.image.load(game.tiles.npc[0]).convert_alpha()
		self.rect	= self.image.get_rect()
		self.pos	= vec(x, y)
		self.rect.x	= x * game.config.tilesize
		self.rect.y	= y * game.config.tilesize 
